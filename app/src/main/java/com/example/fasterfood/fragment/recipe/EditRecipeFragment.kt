...
/*
 *  Name of file: EditRecipeFragment
 *  Author:  Simon, Ormsby
 *  Description: This fragment class is responsible for updating the recipe and update the data in firebase
 * */
class EditRecipeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnUpdate.setOnClickListener {
            ...
            if (isUserLoggedIn()) {
                ...
                Toast.makeText(
                    view.context,
                    "You must have to login to update the recipe",
                    Toast.LENGTH_SHORT
                ).show()
            }
        }
    ...
    private fun updateRecipe() {
        ...
        view?.let {
            recipeService.editRecipe(
                databaseRef, name.text.toString(), description.text.toString(),
    ...
    fun dialog(title: String, body: String, view: Context) {
        ...
        editRecipeBuilder.setPositiveButton("Yes") { dialog, which ->
            ...
            Toast.makeText(
                view,
                "Recipe Updated", Toast.LENGTH_SHORT
            ).show()
    ...
    // this fun is checking if user is logged in or not using shared preferences
