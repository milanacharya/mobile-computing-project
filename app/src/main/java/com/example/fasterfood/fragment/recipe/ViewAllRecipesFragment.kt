...
/*
 *  Name of file: ViewAllRecipesFragment.kt
 *  Author:  Wenliang Jia
 *  Purpose: This class is used to display all recipes in the view all recipe page
 ...
 *               A search function will help the user to filter and find recipes
 * */
class ViewAllRecipesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(
            com.example.fasterfood.R.layout.fragment_view_all_recipes,
            container,
            false
        )
