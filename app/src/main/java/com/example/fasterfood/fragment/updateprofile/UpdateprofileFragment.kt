...
/*
 *  Name of file: UpdateprofileFragment
 *  Author:  Nadish Maredia
 *  Description: This fragment class is responsible when user click on update profile it will show user details
...
class UpdateprofileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(
            com.example.fasterfood.R.layout.fragment_updateprofile,
            container,
            false
        )
        ...
        userRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                var isProfessionalChef =
                    snapshot.child("professional").getValue(Boolean::class.java)
    ...
    fun dialog(title: String, body: String, view: Context) {
        ...
        updateProfileBuilder.setPositiveButton("Yes") { dialog, which ->
            ...
            Toast.makeText(
                view,
                "Profile Update", Toast.LENGTH_SHORT
            ).show()
        }
