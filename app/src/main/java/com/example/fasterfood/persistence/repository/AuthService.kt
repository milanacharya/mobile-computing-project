...
/*
 *  Name of file: AuthService
 *  Author:  Nadish Maredia
 *  Description: This class is actual implementation of interface and responsible for communicating
 *               with the firebase. This auth service implemented the IAuthDAO so instead of writing
 *               login and register code in fragment class its better to have separate service for them
 * */
