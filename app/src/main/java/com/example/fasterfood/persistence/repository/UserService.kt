...
/*
 *  Name of file: UserService
 *  Author:  Nadish Maredia
 *  Description: This class is actual implementation of interface and responsible for communicating
 *               with the firebase. This user service implemented the IUserDAO so instead of writing
 *               updatinguser code in fragment class its better to have separate service for them
 * */
